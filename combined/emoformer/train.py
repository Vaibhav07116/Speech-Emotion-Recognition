...
MODEL_SAVE_PATH = "emoformer_combined.pth"
...
model = Emoformer(
    input_dim=128, dim=256, n_heads=8, n_blocks=4,
    ff_hidden_dim=1024, n_classes=N_CLASSES
).to(device)
...
print(f"\nStarting training for {MODEL_SAVE_PATH} on {len(df)} samples...")
...
# Plotting code here... (same as before)