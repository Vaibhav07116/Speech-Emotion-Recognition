...
# --- Import all your models and dataset functions ---
from model import CnnLstmModel# Add all your model classes here
from dataset import load_all_data, AudioDataset

# --- 1. CONFIGURATION: CHOOSE WHICH MODEL TO EVALUATE ---
MODEL_TYPE = 'CNN+LSTM' # Options: 'Emoformer', 'ResNet', 'CNN+LSTM', etc.

# --- 2. Paths and Parameters ---
# Set the correct paths based on the chosen model
if MODEL_TYPE == 'CNN+LSTM':
    MODEL_PATH = "cnnlstm_combined.pth"
    MODEL_CLASS = CnnLstmModel
else:
    raise ValueError("Invalid MODEL_TYPE selected.")

OUTPUT_IMAGE_PATH = f"roc_curves_{MODEL_TYPE.lower()}.png"
...
plt.title(f'Receiver Operating Characteristic (ROC) - {MODEL_TYPE} Model')
